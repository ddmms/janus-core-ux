...
class EOSTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Structure Selection
        struct_group = QGroupBox("Input Crystal Structure")
        ...
        self.input_file.setPlaceholderText("Path to periodic structure (.cif, .poscar)")
    ...
    def run_eos(self):
        ...
        if not struct_file or not os.path.exists(struct_file):
            struct_file = os.path.join(self.temp_dir, "eos_input.xyz")
